...
using boingtheboeing.WebNowPlayingPlugin.Properties;
    ...
    public class StatusIcon
    {
        ...
        private void MacroDeck_OnMainWindowLoad(object sender, EventArgs e)
        {
            ...
            this.statusButton = new ContentSelectorButton
            {
                BackgroundImage =
                    WNPRedux.clients > 0
                        ? Properties.Resources.wnp_companion
                        : Properties.Resources.wnp_nocompanion,
        ...
        public void UpdateStatusButton(bool connected)
        {
            try
            {
                ...
                var toolip = connected
                    ...
                    : $"WebNowPlaying Redux {version}\r\nNo clients connected at this time";
                statusButton.BackgroundImage = connected
                    ? Resources.wnp_companion
                    : Resources.wnp_nocompanion;
                ;
                _statusToolTip.SetToolTip(statusButton, toolip);
            }
            catch (Exception e)
